...
## ----processData_plot, echo=TRUE,eval=FALSE,cache=TRUE,message=FALSE,warning=FALSE----
plotRegion(nucFree)

## ----processData_plot2, echo=FALSE,eval=TRUE,cache=FALSE,fig.height=5,fig.width=7,message=FALSE,warning=FALSE----
library(soGGi)
...
## ----processData_plot3, echo=TRUE,eval=FALSE,cache=FALSE-----------------
plotRegion(monoNuc)

## ----processData_plot4, echo=FALSE,eval=TRUE,cache=FALSE,fig.height=5,fig.width=7,message=FALSE,warning=FALSE----
...
## ----processData_filterBLKlist, echo=TRUE,eval=TRUE,cache=TRUE,dependson="processData_callQC"----
...
## ----processData_consensusa, echo=TRUE,eval=TRUE,cache=TRUE--------------
...
## ----processData_consensusCounting, echo=TRUE,eval=TRUE,cache=TRUE,dependson="processData_consensusa"----
...
## ----processData_motifCutsfa, echo=FALSE,eval=TRUE,cache=TRUE,dependson="processData_motifCutse"----
